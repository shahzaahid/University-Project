...
CREATE TABLE `wishlistitems` (
  ...
  PRIMARY KEY (`Id`),
  UNIQUE KEY `WishlistProduct` (`Id`),
  KEY `IX_WishListItems_ProductId` (`ProductId`),
  KEY `IX_WishListItems_WishListId` (`WishListId`),
  CONSTRAINT `FK_WishListItems_Products_ProductId` FOREIGN KEY (`ProductId`) REFERENCES `products` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `FK_WishListItems_WishList_WishListId` FOREIGN KEY (`WishListId`) REFERENCES `wishlist` (`Id`) ON DELETE CASCADE
